...
BOT_TOKEN = environ.get('BOT_TOKEN', "5962006329:AAHZs0BT9MpH8bnumd-pSRtdz1XKtSz8o2Q")
...
support_chat_id = environ.get('-1001655704975')
reqst_channel = environ.get('-1001872345446')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Atlascluster")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>VP|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n  \n\n🖥 <i>Requests</i> - ||@vp_supportgroup|| ')
